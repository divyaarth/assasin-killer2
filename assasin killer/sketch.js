...
if (enemy4.isTouching(player)) {
  ...
  if (enemy2.isTouching(wall23)) {
    enemy2.velocityX = 0;
    enemy2.velocityY = -5;
  }
  if (enemy2.isTouching(wall19)) {
    enemy2.velocityX = 5;
    enemy2.velocityY = 0;
  }
  if (enemy2.isTouching(wall20)) {
    enemy2.velocityX = 0;
    enemy2.velocityY = 5;
  }
  if (enemy2.isTouching(wall26)) {
    enemy2.velocityX = 0;
    enemy2.velocityY = -5;
  }
